...
function display(d::REPLDisplay, mime::MIME"text/plain", x)
    ...
    io = IOContext(outstream(d.repl), :limit => true, :module => Main::Module, :last_shown_line_infos => linfos)
...
function print_response(repl::AbstractREPL, @nospecialize(response), show_value::Bool, have_color::Bool)
    ...
    linfos = Tuple{String,Int}[]
    io = IOContext(outstream(repl), :module => Main::Module, :last_shown_line_infos => linfos)
